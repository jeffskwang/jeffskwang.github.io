		...
		for(var i=0; i< N; i++) {
			for (var m=0; m < scale; m++){ 
				for (var n=0; n <scale; n++){
					...
					imagedata.data[pixelindex] = (1.-alpha_cloud)*gray*255; //Red
					imagedata.data[pixelindex+1] = (1.-alpha_cloud)*gray*255; //Green
					imagedata.data[pixelindex+2] = (1.-alpha_cloud)*gray*255; //Blue
					imagedata.data[pixelindex+3] = 255*((1.-alpha_cloud)*1.0+alpha_cloud); //Alpha						
					}
					else{
					imagedata.data[pixelindex] = gray*255; //Red
					imagedata.data[pixelindex+1] = gray*255; //Green
					imagedata.data[pixelindex+2] = gray*255; //Blue
