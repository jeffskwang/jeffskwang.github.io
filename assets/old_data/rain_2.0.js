...
//load direction
$.ajax({
    url: "https://raw.githubusercontent.com/jeffskwang/jeffskwang.github.io/main/assets/data/flow_dir.csv",
    async: false,
...
$.ajax({
    url: "https://raw.githubusercontent.com/jeffskwang/jeffskwang.github.io/main/assets/data/render_R.csv",
    async: false,
    success: function (csvd) {
...
$.ajax({
    url: "https://raw.githubusercontent.com/jeffskwang/jeffskwang.github.io/main/assets/data/render_G.csv",
    async: false,
    success: function (csvd) {
...
$.ajax({
    url: "https://raw.githubusercontent.com/jeffskwang/jeffskwang.github.io/main/assets/data/render_B.csv",
    async: false,
    success: function (csvd) {
...
//load rendered image (red-band)
$.ajax({
    url: "https://raw.githubusercontent.com/jeffskwang/jeffskwang.github.io/main/assets/data/aerial_R.csv",
    async: false,
    success: function (csvd) {
...
//load rendered image (green-band)
$.ajax({
    url: "https://raw.githubusercontent.com/jeffskwang/jeffskwang.github.io/main/assets/data/aerial_G.csv",
    async: false,
    success: function (csvd) {
...
//load rendered image (blue-band)
$.ajax({
    url: "https://raw.githubusercontent.com/jeffskwang/jeffskwang.github.io/main/assets/data/aerial_B.csv",
    async: false,
    success: function (csvd) {
